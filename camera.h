...
class camera {
  public:
   ...
   int image_width = 100;       // in pixel count
   ...
   double focus_dist = 10;    // Distance from camera lookfrom
  ...
  private:
   ...
   ray get_ray(int i, int j) const {
      // Construct a camera ray from the defocus disk directed at a randomly
